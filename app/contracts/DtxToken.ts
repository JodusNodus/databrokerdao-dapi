...
export class DtxToken extends TypeChainContract {
  ...
  static async createAndValidate(
    ...
    const contract = new DtxToken(web3, address)
  ...
  public getByIndex(index: BigNumber | number): Promise<[string, BigNumber]> {
    return promisify(this.rawWeb3Contract.getByIndex, [index.toString()])
  }
  public getByKey(_key: BigNumber | string): Promise<[string, BigNumber]> {
